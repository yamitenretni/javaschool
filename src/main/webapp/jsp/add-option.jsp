...
<form action="/tariffs/add-option" method="post" accept-charset="utf-8">
    ...
    <div class="form-group">
        ...
        <input type="number" min="0" step="0.01" class="form-control" id="connection_cost" name="connection_cost" placeholder="Connection cost">
    </div>
    <div class="form-group">
        <label for="monthly_cost">Monthly cost</label>
        <input type="number" min="0" step="0.01" class="form-control" id="monthly_cost" name="monthly_cost" placeholder="Monthly cost">
    </div>
